...
<?php if($txtImagen!=""){  ?>   
    ...
    <img class="img-thumbnail rounded"  src="../../img/<?php echo $tmpImagen;?>" width="50" alt=""srcset="">
...
<div class="btn-group" role="group" aria-label="">
    ...
    <button type="submit" name="accion" <?php echo($accion!="Seleccionar")?"disabled":"";?>class="btn btn-warning">Modificar></button>
    <button type="submit" name="accion" <?php echo($accion!="Seleccionar")?"disabled":"";?>class="btn btn-info">Cancelar</button>
</div>
